...
eval("__webpack_require__(/*! @babel/register */ \"@babel/register\");\n\nvar express = __webpack_require__(/*! express */ \"express\"); // const path = require(\"path\");\n\n\nvar React = __webpack_require__(/*! react */ \"react\");\n\nvar _require = __webpack_require__(/*! react-dom/server */ \"react-dom/server\"),\n    renderToString = _require.renderToString;\n\nvar temp = __webpack_require__(/*! ./template */ \"./template.js\")[\"default\"];\n\nvar App = __webpack_require__(/*! ./src/page/index */ \"./src/page/index.js\")[\"default\"];\n\nvar app = express();\nvar port = 5020;\nvar isServerRender = true; // 设置静态文件目录\n// app.use(express.static(path.join(__dirname, \"public\")));\n\napp.use(express[\"static\"](\"public\")); // 服务端渲染\n\napp.get(\"/\", function (req, res) {\n  if (isServerRender) {\n    var appString = renderToString( /*#__PURE__*/React.createElement(App, null));\n    var html = temp({\n      body: appString,\n      title: \"test\"\n    });\n    res.send(html);\n  } else {\n    var _html = temp({\n      title: \"test\"\n    });\n\n    res.send(_html);\n  }\n}); // 启动express服务，监听端口\n\napp.listen(port, function () {\n  return console.log(\"\\u670D\\u52A1\\u542F\\u52A8\\u6210\\u529F\\uFF0Chttp://localhost:\".concat(port));\n});\n\n//# sourceURL=webpack:///./server.js?");
